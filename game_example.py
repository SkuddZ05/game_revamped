...
RACING GAME
===========
Built to follow the flowchart:

Loading screen -> Choose game mode
    -> Race vs Opponent -> Match with opponent -> 3-2-1 countdown ->
       Race against opponent -> Finish placement? -> Win/Lose screen
    -> Time Trial -> Start time trial -> 3-2-1 countdown ->
       Race solo for fastest lap -> Record lap times -> New fastest time? ->
       Save new record / Show current best
-> Back to main menu -> Play again? -> Yes: loop back to menu / No: Quit game

Controls:
    LEFT / RIGHT arrows  - steer
    UP arrow             - accelerate
    DOWN arrow           - brake
    ENTER / mouse click  - confirm menu selections
...
# ----------------------------------------------------------------------
# MATCH WITH OPPONENT / START TIME TRIAL (brief transition screens)
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# WIN / LOSE SCREEN  (Finish placement?)
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# RACE SOLO FOR FASTEST LAP  (+ record lap times)
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# NEW FASTEST TIME? -> SAVE NEW RECORD / SHOW CURRENT BEST
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# MAIN FLOW  (mirrors the flowchart exactly)
# ----------------------------------------------------------------------
def main():
    loading_screen()
